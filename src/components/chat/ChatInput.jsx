...
export default function ChatInput({ onSend, side = "right" }) {
  ...
  return (
    <div className="sticky bottom-0 z-10 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/80">
      <div className="mx-auto max-w-[760px] px-4 pt-2">
        <div className="flex items-center gap-3 pb-3 border-t border-neutral-200 pt-3">
          <button
            type="button"
            aria-label="추가"
            className="p-2 rounded-full bg-[#FFFFFF] hover:bg-neutral-200 text-neutral-700"
          >
          ...
          <div className="flex-1">
            <input
              ...
              placeholder="메시지 전송"
              className="w-full rounded-full bg-[#FFFFFF] px-4 py-3 text-[15px] leading-5 outline-none placeholder:text-neutral-400 focus:ring-1 focus:ring-neutral-200 text-neutral-800"
            />
          </div>
          ...
          <button
            ...
            onClick={submit}
            aria-label="전송"
            className="p-2 rounded-full bg-[#FFFFFF] text-white hover:bg-neutral-200"
          >
            <svg
