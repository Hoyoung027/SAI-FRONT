    ...
    <div className="h-screen overflow-y-auto">
      ...
      <div className="flex w-full h-[1rem] items-center justify-between pb-[1rem]">
        ...
        <div className="relative inline-block text-left">
          {/* 정렬 버튼  */}
          <button
            className={`text-[#B5BBC1] text-[0.75rem] bg-[#FFFFFF] border-0 justify-end pr-[1.5rem] ${sortOpen ? "text-[#B5BBC1]" : "text-[#B5BBC1]"}`}
            aria-haspopup="listbox"
            aria-expanded={sortOpen}
            type="button"
            onClick={() => setSortOpen((v) => !v)}
          >
            {sortBy === "popular" ? "인기순" : sortBy === "latest" ? "최신순" : "가나다순"}
            <svg xmlns="http://www.w3.org/2000/svg" width="12" height="6" viewBox="0 0 12 6" fill="none">
              <path fill-rule="evenodd" clip-rule="evenodd" d="M6.35557 5.0785L9.18407 2.25L8.47707 1.543L6.00207 4.018L3.52707 1.543L2.82007 2.25L5.64857 5.0785C5.74233 5.17223 5.86949 5.22489 6.00207 5.22489C6.13465 5.22489 6.2618 5.17223 6.35557 5.0785Z" fill="#B5BBC1"/>
              <path fill-rule="evenodd" clip-rule="evenodd" d="M6.35557 5.0785L9.18407 2.25L8.47707 1.543L6.00207 4.018L3.52707 1.543L2.82007 2.25L5.64857 5.0785C5.74233 5.17223 5.86949 5.22489 6.00207 5.22489C6.13465 5.22489 6.2618 5.17223 6.35557 5.0785Z" fill="black" fill-opacity="0.2"/>
            </svg>
          </button>
              ...
              >
                <li>
                  <button
                    ...
                    className={`
                      text-[#B5BBC1] text-[0.75rem] bg-[#FFFFFF] border-0 pr-[1.5rem] w-full text-left ${sortBy === "popular" ? "" : ""}`}
                  >
                    인기순
                  </button>
                </li>
                <li>
                  <button
                    ...
                    className={`text-[#B5BBC1] text-[0.75rem] bg-[#FFFFFF] border-0 pr-[1.5rem] w-full text-left ${sortBy === "latest" ? "text-gray-900 font-medium" : "text-gray-600"} hover:bg-gray-50`}
                  >
                    최신순
                  </button>
                </li>
                <li>
                  <button
                    ...
                    onClick={() => { setSortBy("title"); setSortOpen(false); }}
                    className={`text-[#B5BBC1] text-[0.75rem] bg-[#FFFFFF] border-0 pr-[1.5rem] w-full text-left ${sortBy === "title" ? "text-gray-900 font-medium" : "text-gray-600"} hover:bg-gray-50`}
                  >
                    가나다순
                  </button>
                </li>
      ...
      <div className="h-[1rem] w-full pb-[0.75rem] pt-[0.5rem] pl-[1.5rem] pr-[1.5rem] flex items-center">
